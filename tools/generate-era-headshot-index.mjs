...
if (!upstreamPath || !outputPath) {
  throw new Error('usage: node tools/generate-era-headshot-index.mjs <hupu-player-photos.js> <output.js>');
}
...
const payload = {
  version:'20260826-era-headshots-v1',
  source:'dhsa33/perfect-player hupu-player-photos csv-2026-08-17 plus verified local historical and official assets',
